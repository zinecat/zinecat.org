...
#
define("__CA_DB_DATABASE__", 'zinecato_collectas');
...
#
define("__CA_SMTP_SERVER__", 'mail.zinecat.org');
...
#define("__CA_SMTP_USER__", 'zucadmin@zinecat.org');
#define("__CA_SMTP_PASSWORD__", '#DigitalPraxis17');
