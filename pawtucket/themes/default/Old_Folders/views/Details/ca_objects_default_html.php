...
?>
			...
			<div class='col-sm-6 col-md-6 col-lg-5'>
				<H4>{{{<unit relativeTo="ca_entities" delimiter="<br/>"><l>^ca_entities.preferred_labels</l></unit><ifcount min="1" code="ca_entities"> ➔ ^ca_objects.preferred_labels.name</ifcount>}}} </H4>
				...
				<hr></hr>
					<div class="row">
						<div class="col-sm-6">		
							{{{<ifcount code="ca_entities" min="1" max="1"><H6>Creator and/or Publishor:</H6></ifcount>}}}
							{{{<ifcount code="ca_entities" min="2"><H6>Creators and/or Publishors:</H6></ifcount>}}}
							...
							{{{<unit relativeTo="ca_objects.external_link" delimiter="<br/>"><H6>Link to Source Collection:</H6>^ca_objects.external_link%returnAsLink=1</1></ifdef>}}}
							
							{{{<ifcount code="ca_list_items" min="1" max="1"><H6>Related Term</H6></ifcount>}}}
							{{{<ifcount code="ca_list_items" min="2"><H6>Related Terms</H6></ifcount>}}}
							{{{<unit relativeTo="ca_list_items" delimiter="<br/>"><1>^ca_list_items.preferred_labels.name_plural</1></unit>}}}
